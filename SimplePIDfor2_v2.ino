...
/*--------------Variables for Computing PID--------------*/
  ...
  const double kp_L = 0.572, ki_L =0.0000001, kd_L = 0.0001;//proportional, integral, derivative gains
  const double kp_R = 0.7903, ki_R = 0.0001, kd_R = 0.00001;   
  ...
  int SampleTime = 200; //Default Sample Rate
 ...
 */
 ...
 Serial.print(",");
 Serial.print(DerivativeLeft);
 Serial.print(",");
 Serial.print(IntegralLeft);
 Serial.print(",");
 Serial.print(PreviousErrorLeft);
 Serial.print(",");
 Serial.print(PID_OutputLeft);
 Serial.print(",");
 Serial.print(ki_L*IntegralLeft);
 Serial.print(",");
 Serial.println(ActuatorCommandLeft);
